...
const portfolio = [
    {
        photo: 'assets/img/dashboard/p-1-700x270.jpg',
        name: "Minimal Cup with Coffee",
        desc: "Portfolio - Showcase",
    },
    {
        photo: 'assets/img/dashboard/p-1-700x540.jpg',
        name: "Minimal Cup with Coffee",
        desc: "Portfolio - Showcase",
    },
    {
        photo: 'assets/img/dashboard/p-3-700x540.jpg',
        name: "Minimal Cup with Coffee",
        desc: "Portfolio - Showcase",
    },
    {
        photo: 'assets/img/dashboard/p-2-700x270.jpg',
        name: "Minimal Cup with Coffee",
        desc: "Portfolio - Showcase",
    },
    {
        photo: 'assets/img/dashboard/p-3-700x270.jpg',
        name: "Minimal Cup with Coffee",
        desc: "Portfolio - Showcase",
    },
    {
        photo: 'assets/img/dashboard/p-2-700x540.jpg',
        name: "Minimal Cup with Coffee",
        desc: "Portfolio - Showcase",
    },
]
