                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 text-md-right">
                            <ul className="invoice-date">
                                <li>Invoice Date : Saturday, January 07 2022</li>
                                <li>Due Date : Sunday, January 19 2022</li>
                            </ul>
                        </div>
                    </div>
                    {/* Invoice Table */}
                            ...
                            <tbody>
                                {invoiceproductlist.map((item, i) => (
                                    <tr key={i}>
                                        ...
                                        <td>{item.qty}</td>
                                        <td>${new Intl.NumberFormat().format((item.cost).toFixed(2))}</td>
                                        <td>${new Intl.NumberFormat().format((item.qty * item.cost).toFixed(2))}</td>
                                    </tr>
                                ))}
                            </tbody>
                            <tfoot>
