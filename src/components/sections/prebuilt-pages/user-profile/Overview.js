...
import Round from '../../ui-basic/progress-bars/Round';
import Smallbars from '../../ui-basic/progress-bars/Smallbars';
            ...
            <Tab.Container defaultActiveKey="tab1">
                <div className="ms-profile-overview">
                    <div className="ms-profile-cover">
                        <img className="ms-profile-img" src={process.env.PUBLIC_URL + "/assets/img/dashboard/rakhan-potik-1.jpg"} alt="people" />
