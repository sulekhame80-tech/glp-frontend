...
// Work Exp
const workexp = [
    { logo: 'assets/img/dashboard/rakhan-potik-1.jpg', name: 'User Research Hub', time: 'January 2013 to Present', designation: 'UX Designer' },
    { logo: 'assets/img/dashboard/rakhan-potik-2.jpg', name: 'User Research Hub', time: 'January 2013 to Present', designation: 'UX Designer' },
    { logo: 'assets/img/dashboard/rakhan-potik-3.jpg', name: 'User Research Hub', time: 'January 2013 to Present', designation: 'UX Designer' },
    { logo: 'assets/img/dashboard/rakhan-potik-3.jpg', name: 'User Research Hub', time: 'January 2013 to Present', designation: 'UX Designer' },
    { logo: 'assets/img/dashboard/rakhan-potik-4.jpg', name: 'User Research Hub', time: 'January 2013 to Present', designation: 'UX Designer' },
    { logo: 'assets/img/dashboard/rakhan-potik-5.jpg', name: 'User Research Hub', time: 'January 2013 to Present', designation: 'UX Designer' },
];
                                    ...
                                    <div key={i} className="col-xl-4 col-md-6 col-sm-12">
                                        <div className="media ms-profile-experience">
                                            <div className="mr-2 align-self-center">
                                                <img src={process.env.PUBLIC_URL + "/" + item.logo} className="ms-img-round ms-img-small" alt={item.name} />
                                            </div>
                            ...
                            {skills.map((item, i) => (
                                <Fragment key={i}>
                                    ...
                                    <div className="progress progress-tiny">
                                        <div className="progress-bar bg-dark-green" role="progressbar" style={{ "width": (item.limit) + '%' }} aria-valuenow={item.limit} aria-valuemin={0} aria-valuemax={100} />
                                    </div>
                                </Fragment>
                            ))}
                        </div>
