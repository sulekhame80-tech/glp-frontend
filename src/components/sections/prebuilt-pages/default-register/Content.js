                ...
                <div className="ms-auth-col">
                    <div className="ms-auth-form">
                        <Form noValidate validated={validated} onSubmit={handleSubmit}>
                            ...
                            <button type="button" className="btn mt-4 d-block w-100 btn-social-login"> <img src={process.env.PUBLIC_URL+"/assets/img/others/facebook.png"} alt="" /> <span>Signup with Facebook</span> </button>
                            <button type="button" className="btn mt-4 d-block w-100 btn-social-login"> <img src={process.env.PUBLIC_URL+"/assets/img/others/google.png"} alt="" /> <span>Signup with Google</span> </button>
