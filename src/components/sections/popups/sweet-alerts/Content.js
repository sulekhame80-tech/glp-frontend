...
class Content extends Component {
    ...
    sweetalertcustom() {
        Swal.fire({
            ...
            imageUrl: '../assets/img/dashboard/product-1-530x240.jpg',
            imageWidth: 400,
            imageHeight: 200,
    ...
    render() {
        return (
            <div className="ms-content-wrapper cardspage">
                <div className="row">
                    <Breadcrumb pageprev={'Popups'} pagecurrent={'Sweet Alerts'} />
                    <div className="col-md-12">
                        <div className="ms-panel">
                            ...
                            <div className="ms-panel-body">
                                <p className="ms-directions">Check <code>/src/components/sections/popups/sweet-alerts/Content.js</code> for reference</p>
                                <div className="row">
