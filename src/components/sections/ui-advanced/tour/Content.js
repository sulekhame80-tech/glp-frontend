        ...
        driver.defineSteps([
            ...
            },
            {
                ...
                popover: {
                    ...
                    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. <img src="../assets/img/dashboard/product-1-530x240.jpg" alt="img"/>',
                    position: 'top'
                }
            },
            {
    ...
    render() {
        return (
            <div className="ms-content-wrapper">
                <div className="row">
                    <Breadcrumb pageprev={'Advanced UI Elements'} pagecurrent={'Tour'} />
