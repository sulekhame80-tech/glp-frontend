                        ...
                        <div className="row">
                            <div className="col-xl-9 col-md-12">
                                <div className="ms-cropper-container">
                                    <img id="cropper-expanded" src={process.env.PUBLIC_URL + '/assets/img/dashboard/cropper-1280x720.jpg'} alt="cropper" />
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-12 p-0">
                                <div className="row col-12 m-auto">
                                    <div className="ms-crop-preview ms-crop-preview-lg col-xl-12 col-md-4 w-100" />
                                    <div className="ms-crop-preview ms-crop-preview-md col-xl-12 col-md-4 w-100" />
                                    <div className="ms-crop-preview ms-crop-preview-sm col-xl-12 col-md-4 w-100" />
                                </div>
                            </div>
                            <div className="col-xl-9 col-md-12">
