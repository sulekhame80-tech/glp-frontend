...
// To do
const todolist = [
    { img: 'assets/img/dashboard/product-1.jpg', title: 'Parious Versions has evolved over the years', text: 'It is a long established fact that a reader will be distracted by the content' },
    { img: 'assets/img/dashboard/product-1.jpg', title: 'Parious Versions has evolved over the years', text: 'It is a long established fact that a reader will be distracted by the content' },
    { img: 'assets/img/dashboard/product-1.jpg', title: 'Parious Versions has evolved over the years', text: 'It is a long established fact that a reader will be distracted by the content' },
];
                        ...
                        <ul className="ms-list ms-droppable ms-sortable" ref="sortable">
                            {todolist.map((item, i) => (
                                <li key={i} className="ms-list-item bordered media ms-draggable" onChange={this.handleOnChange}>
                                    <img className="ms-img-round" src={process.env.PUBLIC_URL + "/" + item.img} alt={item.title} />
