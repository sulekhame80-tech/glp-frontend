                ...
                <div className="ms-panel-body">
                    <div className="row">
                        <div className="col-xl-4 col-md-4 col-sm-6 col-6 ms-device">
                            <i className="material-icons bg-secondary">desktop_windows</i>
                            <h4>Desktop</h4>
                            <p className="ms-text-primary">45.07%</p>
                            <p className="ms-text-primary">201,434</p>
                        </div>
                        <div className="col-xl-4 col-md-4 col-sm-6 col-6 ms-device">
                            <i className="material-icons bg-light-green">tablet_mac</i>
                            <h4>Tablet</h4>
                            <p className="ms-text-danger">29.05%</p>
                            <p className="ms-text-danger">134,693</p>
                        </div>
                        <div className="col-xl-4 col-md-4 col-sm-6 col-6 ms-device">
                            <i className="material-icons bg-dark-green">phone_iphone</i>
                            <h4>Mobile</h4>
                    ...
                    <div className="progress">
                        <div className="progress-bar bg-secondary" role="progressbar" style={{ width: '45.07%' }} aria-valuenow="45.07" aria-valuemin={0} aria-valuemax={100} />
                        <div className="progress-bar bg-light-green" role="progressbar" style={{ width: '29.05%' }} aria-valuenow="29.05" aria-valuemin={0} aria-valuemax={100} />
                        <div className="progress-bar bg-dark-green" role="progressbar" style={{ width: '25.48%' }} aria-valuenow="25.48" aria-valuemin={0} aria-valuemax={100} />
                    </div>
                </div>
