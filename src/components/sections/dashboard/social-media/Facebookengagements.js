...
function engagedusers() {
    return {
        ...
        datasets: [{
            ...
            pointBorderColor: 'linear-gradient(to bottom left, #0f5c87 1%, #31c7d4 83%);',
            pointBackgroundColor: 'linear-gradient(to bottom left, #0f5c87 1%, #31c7d4 83%);',
            pointHoverBackgroundColor: 'linear-gradient(to bottom left, #0f5c87 1%, #31c7d4 83%);',
            ...
            pointRadius: 0,
            fill: true,
            backgroundColor: "rgba(38, 137, 104,0.3)",
            borderWidth: 2,
...
class Facebookengagements extends Component {
                ...
                <div className="ms-panel ms-panel-fh ms-facebook-engagements">
                    ...
                    <div className="ms-panel-body p-0">
                        <div className="ms-facebook-page-selection">
                            <p className="ms-text-dark">Jan 25, 2022 to Feb 02, 2022</p>
