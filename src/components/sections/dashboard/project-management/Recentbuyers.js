...
const recentbuyers = [
    ...
    {
        userimg: 'assets/img/dashboard/rakhan-potik-4.jpg',
        username: 'Alesdro Guitto',
        servicename: 'Dashboard Design',
        productid: 235193138
    },
    {
        userimg: 'assets/img/dashboard/rakhan-potik-5.jpg',
                            ...
                            <table className="table table-hover thead-light mb-0">
                                ...
                                <tbody>
                                    {recentbuyers.map((item, i) => (
                                        <tr key={i}>
                                            <td className="ms-table-f-w"> <img src={process.env.PUBLIC_URL + "/" + item.userimg} alt={item.username} /> {item.username} </td>
