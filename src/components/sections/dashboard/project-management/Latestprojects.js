...
const projects = [
    {
        username: 'Wright Doe',
        userimg: 'assets/img/dashboard/rakhan-potik-1.jpg',
        time: '30 seconds ago',
    ...
    },
    {
        ...
        title: 'This is a project name',
        text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nunc velit, dictum eget nulla a, sollicitudin rhoncus orci. Vivamus nec commodo turpis.',
        postimg: 'assets/img/dashboard/product-3-530x240.jpg',
        likes: 982,
        comments: 785
    },
];
                                ...
                                <div key={i} className="col-lg-4 col-md-6 col-sm-6">
                                    <div className="ms-card">
                                        <div className="ms-card-body">
                                            <div className="media fs-14">
                                                <div className="mr-2 align-self-center">
                                                    <img src={process.env.PUBLIC_URL + "/" + item.userimg} className="ms-img-round" alt={item.username} />
                                                </div>
                                                <div className="media-body">
                                                    <h6>{item.username}</h6>
                                                    <Dropdown className="dropdown float-right">
                                                        <Dropdown.Toggle as={NavLink} className="p-0 icon-none"><i className="material-icons">more_vert</i></Dropdown.Toggle>
                                        ...
                                        <div className="ms-card-img">
                                            <img src={process.env.PUBLIC_URL + "/" + item.postimg} alt={item.username} />
                                        </div>
