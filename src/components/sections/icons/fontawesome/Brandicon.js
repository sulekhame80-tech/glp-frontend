        ...
        return (
            <div className="col-md-12">
                <div className="ms-panel">
                    ...
                    <div className="ms-panel-body pb-3">
                        <div className="row ms-icons-list">
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="cc BTC" /> fa-bitcoin <span className="text-muted">(alias)</span> </div>
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="fab fa-ge" /> fa-ge <span className="text-muted">(alias)</span> </div>
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="fab fa-ra" /> fa-ra <span className="text-muted">(alias)</span> </div>
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="fab fa-wechat" /> fa-wechat <span className="text-muted">(alias)</span> </div>
